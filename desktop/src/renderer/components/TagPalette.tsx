...
export function TagPalette({ open, x, y, tags, selectedIndex, onSelect, onClose }: Props) {
  ...
  if (!open || tags.length === 0) return null
        ...
        <div style={{ overflowY: 'auto', padding: '4px 0' }}>
          {tags.map((tag, idx) => {
            ...
            return (
              ...
              >
                <span style={{ fontSize: 11, color: 'var(--subtext)', flexShrink: 0 }}>#</span>
                <span style={{
