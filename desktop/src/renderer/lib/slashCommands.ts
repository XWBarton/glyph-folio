...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { id: 'table',     label: 'Table',        description: 'Numbered table with caption',                  icon: '⊞', category: 'structure', snippet: '#figure(\n  table(\n    columns: (${1:1fr}, ${2:1fr}, ${3:1fr}),\n    [${4:Header}], [${5:Header}], [${6:Header}],\n    [${7:Cell}], [${8:Cell}], [${9:Cell}],\n  ),\n  caption: [$10],\n) <tab:$11>\n$0', keywords: ['table', 'grid', 'data'] },
  ...
  { id: 'reference', label: 'Reference',    description: 'Link to a figure, table, or heading',         icon: '→', category: 'structure', snippet: '@${1:fig:label}$0',                                                                                                                                                       keywords: ['reference', 'ref', 'link', 'crossref', 'figure', 'table'] },
  ...
  { id: 'image',    label: 'Image',        description: 'Numbered figure with caption',               icon: '⬚', category: 'media', snippet: '#figure(\n  image("${1:path/to/image.png}", width: ${2:80%}),\n  caption: [$3],\n) <fig:$4>\n$0', keywords: ['image', 'figure', 'picture', 'photo', 'img'] },
